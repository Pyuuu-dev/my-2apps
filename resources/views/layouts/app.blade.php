        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 min-h-0 overflow-y-auto overscroll-contain p-4 space-y-1 sidebar-scroll">
                ...
                <div class="pt-4">
                    ...
                    @php
                        $bfOps = [
                            ...
                            ['route' => 'bloxfruit.rekap', 'match' => 'bloxfruit.rekap', 'label' => 'Rekap Bulanan', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', 'gradient' => 'from-purple-500 to-purple-600'],
                        ];
                    @endphp
                ...
                {{-- DT: Utama --}}
                    @php
                        $dtMain = [
                            ['route' => 'diet.dashboard', 'match' => 'diet.dashboard', 'label' => 'Dashboard', 'icon' => 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z', 'gradient' => 'from-emerald-500 to-emerald-600'],
                            ['route' => 'diet.users.index', 'match' => 'diet.users.*', 'label' => 'Users', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', 'gradient' => 'from-blue-500 to-blue-600'],
                            ['route' => 'diet.stats', 'match' => 'diet.stats', 'label' => 'Statistik', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', 'gradient' => 'from-orange-500 to-orange-600'],
                        ];
                    @endphp
                    ...
                    {{-- DT: Data --}}
                    <p class="px-3 pt-3 pb-1 text-[9px] font-semibold uppercase tracking-wider text-gray-600">Data & Log</p>
                    @php
                        $dtData = [
                            ['route' => 'diet.food-db', 'match' => 'diet.food-db*', 'label' => 'Database Makanan', 'icon' => 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4', 'gradient' => 'from-teal-500 to-teal-600'],
                            ['route' => 'diet.ai-logs', 'match' => 'diet.ai-logs', 'label' => 'AI Logs', 'icon' => 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z', 'gradient' => 'from-purple-500 to-purple-600'],
                        ];
                    @endphp
                    ...
                    <a href="{{ route('settings') }}" @click="closeSidebar()" class="sidebar-link {{ request()->routeIs('settings*') ? 'sidebar-link-active-green' : 'text-gray-400' }}">
                        <div class="sidebar-icon bg-gradient-to-br from-gray-500 to-gray-600">
