...
<head>
    ...
    <title>Blox Fruit Store - Joki & Akun Murah</title>
...
<body class="bg-slate-950 text-white antialiased">
    ...
    <nav class="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-slate-950/80 border-b border-white/5">
        <div class="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="#" class="flex items-center gap-2">
                ...
                <span class="font-extrabold text-sm">BF Store</span>
            </a>
    ...
    <section class="hero-bg pt-28 pb-16 px-4 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center relative">
            ...
            <h1 class="text-4xl sm:text-5xl font-black leading-tight mb-4">
                Blox Fruit <span class="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Store</span>
            </h1>
    ...
    <section id="kontak" class="py-16 px-4">
        <div class="max-w-2xl mx-auto text-center">
            <div class="rounded-3xl bg-gradient-to-br from-indigo-600 to-purple-700 p-10 shadow-2xl shadow-indigo-500/20 glow">
                ...
                <div class="flex flex-wrap justify-center gap-3">
                    <a href="https://wa.me/6285954714723" target="_blank" class="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-bold text-gray-900 hover:bg-gray-100 transition-colors shadow-lg">
    ...
    <footer class="border-t border-white/5 py-6 px-4">
        <div class="max-w-6xl mx-auto flex items-center justify-between">
            <p class="text-xs text-gray-600">&copy; {{ date('Y') }} BF Store</p>
            <p class="text-xs text-gray-600">Blox Fruit Joki & Akun</p>
        </div>
    </footer>
